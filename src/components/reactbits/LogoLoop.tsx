...
//& src: https://reactbits.dev/r/LogoLoop-TS-TW (ts + tailwind variant), vendored verbatim except for: 'use client' directive, eslint disable comments on both hooks that intentionally take caller-supplied dependency lists and on raw <img>, and `(item as any)` casts replaced by narrowing on `isNodeItem` (strict ts, same behaviour).
